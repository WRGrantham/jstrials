...
accountInfo("Balloonicorn", 123456, "Balloonicorn's Cupcake Shop");


// Add function to print all addresses, including a header
function showAddresses(addresses){
  console.log(`Addesses:`)
  for (let address of addresses) {
    console.log(address);
  }
}
showAddresses(["123 Main Street", "683 Sutter Street", "1600 Pennsylvania Ave"]);
...
function showTransactions(transactions, startingBalance) {
  console.log(`Starting Balance: ${startingBalance}`);
  for (keyValue of transactions){
